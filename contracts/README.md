...
| 컨트랙트 | 주소 |
|---|---|
| `PredixScoreRegistry` | [`0x8FC03B689D14D25d296A15Da307764d6359f5BF0`](https://app.roninchain.com/address/0x8FC03B689D14D25d296A15Da307764d6359f5BF0) |
...
- `PredixScoreRegistry` — gas-sponsored commit-reveal 방식의 예측 기록기 (blockpick 패턴: `_userAddress` 명시)
  - `commit(user, hash, marketRef, revealAfter)` — sponsor가 호출해도 ownership은 `user`로 기록
